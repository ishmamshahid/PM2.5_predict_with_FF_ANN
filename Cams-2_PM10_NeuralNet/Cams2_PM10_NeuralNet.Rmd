...
r2 <- r2 + labs(x = "Actual", y = "Predicted", title = "Correlation Plot of PM10 (CAMS-2)")
...
For predicting weekly averaged values, based on the minimum RMSE, the model with 15 neurons performs best. The architecture is shown:
```{r}
