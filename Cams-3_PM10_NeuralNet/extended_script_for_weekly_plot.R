...
w_10_3<- ggplot(data = wk_plot_df, aes(x = date)) +
  ...
  labs( y = "PM 10", title = "Predicted vs Observed values of PM 10 (weekly avg.) during 2018 in CAMS-3")

w_10_3

# Save an object to a file
saveRDS(w_10_3, file = "w_10_3.rds")
saveRDS(p_10_3, file = "p_10_3.rds")
