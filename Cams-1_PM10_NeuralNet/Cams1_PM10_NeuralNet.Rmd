...
Based on the error metrics the model with 3 neurons performs best. The model architecture is shown
```{r,warning=FALSE}
...
For predicting weekly averaged values, based on the minimum RMSE, the model with 3 neurons performs best. The architecture is shown:
```{r}
